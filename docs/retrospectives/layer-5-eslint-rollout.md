...
2. **Closure invariant was incomplete.** Initially propagated scripts/ci/check_* wrappers without the corresponding tests/test_*.sh files — caught by codex Phase 4b on PR#316, fixed via [mergepath#320](https://github.com/nathanjohnpayne/mergepath/issues/320). The closure rule needs better static checking.
